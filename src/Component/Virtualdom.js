...
export const Virtualdom = () => {
  return (
    <div className='vd'>
        <h1 align="center">Virtual Dom</h1>
        <p>Virtual Dom is just a copy of real dom,whenever there is a change in the state of any element, a new Virtual DOM tree is created. This new Virtual DOM tree is then compared with the previous Virtual DOM tree and make a note of the changes. After this, it finds the best possible ways to make these changes to the real DOM. Now only the updated elements will get rendered on the page again.</p>
       <h2>Virtual DOM Key Concepts :</h2>
       <ul>
